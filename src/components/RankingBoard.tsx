                    ...
                    <>
                        ...
                        {top3.length > 0 ? (
                            <div className="flex items-end justify-center gap-2 mb-6 px-2 min-h-[160px]">
                                ...
                                {renderPodiumCard(top3[0], 1, { mt: '-mb-4', scale: 'scale-110 z-20', badge: 'bg-yellow-400 text-yellow-900', cardBorder: 'border-yellow-500', cardShadow: 'shadow-xl shadow-yellow-500/20' })}
